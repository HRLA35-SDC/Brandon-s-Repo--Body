// let data = require('./rawUnparsedData.js')
const fs = require('fs')
var rawData = [];
var properFormat;
// fs.readFile(`${__dirname}/rawUnparsedData.js`, "utf8", (err, result) => {
...
function parseRaw() {
  try {
    const data = fs.readFileSync(`${__dirname}/rawUnparsedData.js`, 'utf8')
    console.log(data)
    rawData = data;
  } catch (err) {
      console.error(err)
  ...
  // console.log(typeof rawData, "HELLO")
  // console.log("RAWDATA SIZE", rawData.length);
  properFormat = rawData.map((shoe) => (
    {
        name: shoe.name,
        gender: shoe.gender,
...
// console.log(string, "I PRINTED THIS")
